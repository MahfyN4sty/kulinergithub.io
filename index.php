...
<body>
    ...
    <div class="badan-utama">
        ...
        <div class="banner">
            <img src="ayamsambal.jfif" alt="Ayam Goreng Sambal">
        </div>
        ...
        <div class="menu-tengah">
            <div class="kotak">
                ...
                <img src="satekambing.jfif" alt="Sate Ayam">
        ...
        <div class="menu-kanan">
            <div class="kotak">
                <h3>Jadwal Buka</h3>
                <img src="Warteg.png" alt="Sate Ayam">

                <h4 align="center"> Jadwal Buka </h4>
                   <center>
                    <p2>Senin-Minggu 08.00 WIB - 22.00 WIB</p2>
                    </center>
            </div>
